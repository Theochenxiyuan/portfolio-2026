...
demo: 'https://free-d8gvncva4ce29a4b5-1300215740.tcloudbaseapp.com/'
uiShots:
...
因此我采用了一种注重效率的原型验证工作流：

| 步骤 | 方法           | 目的                                                          |
| :--- | :------------- | :------------------------------------------------------------ |
| 1    | 低保真线框     | 剥离色彩和样式，专注于L1-L3布局及编辑模式信息层级             |
| 2    | 可交互原型     | 借助 AI 辅助将线框与内容规范快速转化为可点击原型，覆盖消费侧与创作侧主要流程 |
| 3    | 迭代打磨       | 沿着真实使用路径反复走查，针对卡点改进交互与信息呈现          |
| 4    | 场景化数据验证 | 用贴近真实的IP数据覆盖节点多态、软锁状态、长列表等边界场景    |
| 5    | 体验验证       | 产出可直接体验的Demo，收集反馈并验证核心交互逻辑              |
...
在原型结论得到验证后，产品进一步接入了后端，演进为完整版本。若想对比原型阶段的形态，可查看[早期原型 Demo](https://seriesguidedemo-amgov01ad.maozi.io/)。

<figure>
  <img src="/case-study/series-guide/prototyping.webp" alt="线框图对比可交互原型" />
  <figcaption>图 3：线框图对比可交互原型</figcaption>
</figure>
